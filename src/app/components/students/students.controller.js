  angular
    .module('skoolforum')
    .controller('StudentController',['$http','StudentResource','AuthenticationService',function($http,StudentResource,AuthenticationService){
                          var vm = this;
                        ...
                        vm.addstudent = function(){
                              ...
                              //    console.log(data)
                              // });
                              StudentResource.save(vm.newstudent);
                              console.log("Saved");
